...
<html lang="en">
  <head>
    ...
    <title>Finance-Ku | Pencatatan Keuangan Digital</title>
    <style>
      .card-finances {
        -webkit-box-shadow: inset 10px -1px 44px -35px rgba(0,0,0,0.75);
-moz-box-shadow: inset 10px -1px 44px -35px rgba(0,0,0,0.75);
